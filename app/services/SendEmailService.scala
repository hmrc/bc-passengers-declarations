...
trait SendEmailService {
  ...
  def constructAndSendEmail(reference: ChargeReference)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Boolean] = {
  ...
  private[services] def getDeclaration(reference: ChargeReference)(implicit ec: ExecutionContext): Future[Declaration] = {
